...
class CargosControllerTest < ActionController::TestCase
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post :create, cargo: { codigo: @cargo.codigo, descricao: @cargo.descricao, salario: @cargo.salario }
    end
  ...
  test "should update cargo" do
    patch :update, id: @cargo, cargo: { codigo: @cargo.codigo, descricao: @cargo.descricao, salario: @cargo.salario }
    assert_redirected_to cargo_path(assigns(:cargo))
  end
